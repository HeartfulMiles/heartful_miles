          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <h1 className="text-2xl font-bold text-blue-600">Happy Miles</h1>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Your Dream
                <span className="text-blue-600 block">Vacation Awaits</span>
              </h1>
              <p className="text-xl text-gray-600 leading-relaxed">
                We craft unforgettable travel experiences tailored to your dreams. 
                From exotic destinations to luxury accommodations, we make your 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Luxury Experiences</h3>
              <p className="text-gray-600 leading-relaxed">
                Access to exclusive hotels, private tours, and VIP experiences that make your trip truly extraordinary.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-2xl shadow-lg">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 text-sm">Honeymoon in Bali</p>
                </div>
              </div>
              <p className="text-gray-700 leading-relaxed">
                "Happy Miles made our honeymoon absolutely perfect! Every detail was taken care of,
                from the romantic dinners to the private villa. We couldn't have asked for a better experience."
              </p>
            ...
            <div className="bg-gray-50 p-8 rounded-2xl shadow-lg">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 text-sm">Family Trip to Europe</p>
                </div>
              </div>
              <p className="text-gray-700 leading-relaxed">
                "Planning a family trip to Europe seemed overwhelming, but Happy Miles made it seamless.
                The kids loved every activity, and we parents could relax knowing everything was handled."
              </p>
              <div className="flex text-yellow-400 mt-4">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="bg-gray-50 p-8 rounded-2xl shadow-lg">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 text-sm">Solo Adventure in Japan</p>
                </div>
              </div>
              <p className="text-gray-700 leading-relaxed">
                "As a solo traveler, I was nervous about visiting Japan, but Happy Miles created the perfect
                itinerary. I felt safe and supported throughout my entire journey. Highly recommend!"
              </p>
              <div className="flex text-yellow-400 mt-4">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-blue-100">hello@happymiles.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-blue-100">123 Travel Street, Adventure City, AC 12345</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl">
              <form className="space-y-6">
                ...
                <input
                  type="text"
                  placeholder="Trip Destination (e.g., Bali, Paris, Tokyo)"
                  className="w-full px-4 py-3 rounded-lg bg-white/20 border border-white/30 text-white placeholder-blue-100 focus:outline-none focus:ring-2 focus:ring-white/50"
                />
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-white text-sm font-medium mb-2">Trip Start Date</label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label className="block text-white text-sm font-medium mb-2">Trip End Date</label>
                    <input
                      type="date"
                      className="w-full px-4 py-3 rounded-lg bg-white/20 border border-white/30 text-white focus:outline-none focus:ring-2 focus:ring-white/50"
                    />
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 rounded-lg bg-white/20 border border-white/30 text-white placeholder-blue-100 focus:outline-none focus:ring-2 focus:ring-white/50 resize-none"
                ></textarea>
                <button
                  type="submit"
                  className="w-full bg-white text-blue-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transition-colors"
                >
                  Send Message
                </button>
              </form>
      ...
      <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-2xl font-bold text-blue-400 mb-4">Happy Miles</h3>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Happy Miles. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
