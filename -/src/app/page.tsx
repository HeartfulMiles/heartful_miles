...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-cyan-50">
      {/* Navigation */}
      <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 bg-white/30 backdrop-blur-xl z-50 rounded-3xl border border-white/30 shadow-2xl">
        <div className="px-8 py-2">
          <div className="flex justify-between items-center">
            ...
            <div className="md:hidden">
              <button className="text-gray-900 hover:text-teal-600 p-2 rounded-full hover:bg-white/50 transition-all duration-300">
